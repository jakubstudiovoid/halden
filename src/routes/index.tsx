  ...
  return (
    <>
      ...
      <section className="field-wash relative isolate overflow-hidden">
        <picture>
          <source media="(min-width: 768px)" srcSet="/media/team.jpg" />
          <img
            src="/media/team-mobile.jpg"
            alt={ui.heroAlt}
            width={1280}
            height={2293}
        ...
        <div className="relative z-10 mx-auto flex min-h-screen max-w-6xl flex-col px-6 pt-[104vw] pb-16 md:px-16 md:pt-36 md:pb-20">
          <div className="mt-auto">
            ...
            <h1 className="reveal display -ml-[0.086em] mt-8 text-6xl uppercase sm:text-8xl lg:text-9xl">Halden</h1>
          </div>
          ...
          <div className="reveal mt-12 flex flex-wrap items-center gap-x-8 gap-y-3">
            ...
            <RouteLink to={links.approach} className="link-draw inline-flex min-h-11 items-center text-xs leading-none tracking-[0.14em] text-field-fg uppercase">
              {ui.heroMore}
            </RouteLink>
          </div>
